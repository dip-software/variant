...
We'd love for you to contribute to our source code and to make the variant even better than it is today!
...
In Github, send a pull request to original main branch: f.e. `variant:main`.
...
[github]: https://github.com/dip-software/variant/issues 
